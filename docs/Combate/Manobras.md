...
Desembarace-se do seu adversário para mover-se sem riscos de sofrer um Ataque de Oportunidade. 
...
Quando usando armas leves em duas mãos, faça ambos os ataques pagando apenas um (1) PA.
